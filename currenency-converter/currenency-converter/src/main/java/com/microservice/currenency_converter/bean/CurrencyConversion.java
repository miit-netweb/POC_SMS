package com.microservice.currenency_converter.bean;
...
public class CurrencyConversion {
    ...
    public CurrencyConversion(Long id, String from, String to, BigDecimal conversionMultiple, BigDecimal quantity, BigDecimal totalCalculatedAmout, String environment) {
        this.id = id;
        this.from = from;
        this.to = to;
